...
=end
  config.include EndpointClassGeneratorHelper, :endpoint_class_generator
  config.include EndpointClassConfigGeneratorHelper, :endpoint_class_config_generator
  config.include EndpointClassesGeneratorHelper, :endpoint_classes_generator
